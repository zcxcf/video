...
def build_image_dataset(args):
    ...
    if args.dataset == 'imagenet':
        dataset_train = datasets.ImageFolder(os.path.join(args.ini_path, 'train'), transform=transform_train)
        dataset_val = datasets.ImageFolder(os.path.join(args.ini_path, 'val'), transform=transform_val)
        nb_classes = 1000
        metric = "accuracy"
