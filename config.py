...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='stage2_500_', type=str, metavar='MODEL',
    ...
    parser.add_argument('--stage_epochs', default=[10, 15, 20, 25, 30, 35], type=list)
    # parser.add_argument('--stage_epochs', default=[7, 12, 17, 22], type=list)



    parser.add_argument('--stage_fined_epochs', default=[10, 12, 14, 16, 18, 20, 22, 24], type=list)
    ...
    parser.add_argument('--data_path', default=r'/home/nus-zwb/reuse/code/train/data', type=str,
                        help='dataset path')
    parser.add_argument('--ini_path', default='/data/common/ImageNet', type=str,
                        help='dataset name')



    parser.add_argument('--dataset', default='cifar100_full', type=str,
                        help='dataset name')
